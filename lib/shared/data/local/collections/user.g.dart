...
void _userSerialize(
  ...
  writer.writeLong(offsets[0], object.followersCount);
  writer.writeLong(offsets[1], object.followingCount);
  writer.writeString(offsets[2], object.name);
  writer.writeString(offsets[3], object.profilePictureUrl);
  writer.writeString(offsets[4], object.remoteId);
  writer.writeLong(offsets[5], object.tripsCount);
...
User _userDeserialize(
  ...
  final object = User();
  object.followersCount = reader.readLong(offsets[0]);
  object.followingCount = reader.readLong(offsets[1]);
  object.id = id;
...
extension UserByIndex on IsarCollection<User> {
  ...
  Future<Id> putByRemoteId(User object) {
    return putByIndex(r'remoteId', object);
  }

  Id putByRemoteIdSync(User object, {bool saveLinks = true}) {
    return putByIndexSync(r'remoteId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByRemoteId(List<User> objects) {
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> followingCountEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<User, User, QAfterFilterCondition> followingCountGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> followingCountLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> followingCountBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<User, User, QAfterFilterCondition> remoteIdContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'remoteId',
  ...
  QueryBuilder<User, User, QAfterFilterCondition> tripsCountEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<User, User, QAfterFilterCondition> tripsCountGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> tripsCountLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> tripsCountBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension UserQuerySortBy on QueryBuilder<User, User, QSortBy> {
  QueryBuilder<User, User, QAfterSortBy> sortByFollowersCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'followersCount', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByFollowersCountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'followersCount', Sort.desc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByFollowingCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'followingCount', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByFollowingCountDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterSortBy> sortByTripsCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'tripsCount', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByTripsCountDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserQuerySortThenBy on QueryBuilder<User, User, QSortThenBy> {
  QueryBuilder<User, User, QAfterSortBy> thenByFollowersCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'followersCount', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByFollowersCountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'followersCount', Sort.desc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByFollowingCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'followingCount', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByFollowingCountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'followingCount', Sort.desc);
    });
  }
  ...
  QueryBuilder<User, User, QAfterSortBy> thenByTripsCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'tripsCount', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByTripsCountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'tripsCount', Sort.desc);
    });
  }
...
extension UserQueryWhereDistinct on QueryBuilder<User, User, QDistinct> {
  QueryBuilder<User, User, QDistinct> distinctByFollowersCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'followersCount');
    });
  }

  QueryBuilder<User, User, QDistinct> distinctByFollowingCount() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QDistinct> distinctByRemoteId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QDistinct> distinctByTripsCount() {
    return QueryBuilder.apply(this, (query) {
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, int, QQueryOperations> followersCountProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'followersCount');
    });
  }

  QueryBuilder<User, int, QQueryOperations> followingCountProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, int, QQueryOperations> tripsCountProperty() {
    return QueryBuilder.apply(this, (query) {
